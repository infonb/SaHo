export interface StateMaster { st_id: number; stId?: number; st_name: string; stName?: string; created_at: string; createdAt?: string; updated_at: string | null; updatedAt?: string | null; }
export interface DistrictMaster { dist_id: number; distId?: number; dist_name: string; distName?: string; st_id: number; stId?: number; created_at: string; createdAt?: string; updated_at: string | null; updatedAt?: string | null; }
export interface MandalMaster { mndl_id: number; mndlId?: number; mndl_name: string; mndlName?: string; dist_id: number; distId?: number; created_at: string; createdAt?: string; updated_at: string | null; updatedAt?: string | null; }
export interface VillageMaster { vil_id: number; vilId?: number; vil_name: string; vilName?: string; vil_pincode: number; vilPincode?: number; mndl_id: number; mndlId?: number; created_at: string; createdAt?: string; updated_at: string | null; updatedAt?: string | null; }
export interface SchoolMaster { sch_id: number; schId?: number; sch_name: string; schName?: string; sch_address: string; schAddress?: string; vil_id: number; vilId?: number; created_at: string; createdAt?: string; updated_at: string | null; updatedAt?: string | null; }
